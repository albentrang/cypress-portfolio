...
const sortHighestBtn = document.getElementById('sort-highest-btn');
const sortLowestBtn = document.getElementById('sort-lowest-btn');
...
function filterTasks() {
    ...
    let filtered = [];
    if (val.startsWith('#')) {
        filtered = tasks.filter((t) => t.tags.some((tag) => tag.toLowerCase() === val));
    }
    else {
...
//# sourceMappingURL=to_do_list.js.map